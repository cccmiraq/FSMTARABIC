...
*/
	var u = "https://dl.dropbox.com/s/icxwgskzcknabj6/fsmt_sites.csv?dl=0";
	var map, loc, name;
...
//********  when clicking on a marker  ********//
			...
			function info(h){
				...
				//******************************************************************adding name, coordinates and last update After closing the <h3 tag in below line the PDF button is omitted. This is the code for it. <br><button id="icon-print">Export PDF</button>
	...
	//////
				...
				function addMap(w,containerScale){				
					...
					var mapHeightInPDF = 70 ; // size of map on paper (or set height but not both)
