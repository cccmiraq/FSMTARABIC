var config = {
		...
		//URL of the CSV
		url : "https://data.humdata.org/dataset/arabicfsmt",
		...
		categories : [
			...
			{
				name : "wash",
				alias : "الماء، الصرف الصحي، النظافة",
			...
			{
				name : "vulnerable",
				alias : "السكان الضعفاء",
				icon : "people_elderly_60px_bluebox"
			},
			{
				name : "nfi",
				alias : "المواد غير الغذائية",
			...
			{
				name : "who_what",
				alias : "من يعمل ماذا واين ؟",
				icon : "activity_partnership_60px_bluebox"
			},
			{
				name : "food_security",
				alias : "الأمن الغذائية",
...
// traffic lights rules
	...
	//nonered
			...
			if (v == "لاشي" || v == "لا اعلم" || v == "لاشي" || v == "لا اعلم" || v == "لا" || v == "لا") {
				result= "danger"
			}
			else {
				result= "success"
	...
	//percentagegreen
			...
			if (v == "اكثر من 75%" || v == "more 75%") {
				result= "success"
			}
			else if (v == "بين 50% و 75%" || v == "btw 50% 75%") {
				result= "warning"
			}
			else {
				result= "danger"
	...
	//percentagered
			...
			else if (v == "بين 50% و 75%" || v == "btw 50% 75%" || v == "btw 25% 50%" || v == "btw_25%_50%") {
				result= "warning"
			}
			else {
				result= "success"
